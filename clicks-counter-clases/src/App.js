...
class App extends React.Component {
  constructor() {
    super();
    this.state = { numeClicks: 0 };
    this.manejarClick = this.manejarClick.bind(this);
    this.reiniciarContador = this.reiniciarContador.bind(this);
  };

  manejarClick() { this.setState(({ numeClicks }) => ({ numeClicks: numeClicks +1 }) ); };

  reiniciarContador() { this.setState({ numeClicks: 0}); };
    ...
    return (
      <div className = 'App'>
        ...
        <div className = 'click-container'>
          <Contador numClicks = { this.state.numeClicks } />
